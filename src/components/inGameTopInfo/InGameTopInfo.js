    ...
    render() { 
        return ( 
            <ul className="in-game-top-info">
                <li className="in-game-top-info__element emoji emoji--timer"><h1>{this.props.props.countDownTimer}</h1></li>
                <li className="in-game-top-info__element emoji emoji--timer"><h1>{this.props.props.totalTimeOnTask}</h1></li>
